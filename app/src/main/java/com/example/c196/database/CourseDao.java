...
public interface CourseDao {
    ...
    LiveData<List<CourseEntity>> getCoursesByTermId(final int termId);
    ...
    @Query("select count(id) from courses where termId = :termId")
    int getCoursesCountByTermId(int termId);
}